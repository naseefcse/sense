...
#include "compcxx_sim_shr.h"
class compcxx_SimpleChannel_22;
...
public:compcxx_SimpleChannel_22* p_compcxx_parent;};

/*template <class PACKET>

*/
#line 30 "../../phy/simple_channel.h"
class compcxx_SimpleChannel_22 : public compcxx_component, public TypeII
{
 public:
  ...
  compcxx_SimpleChannel_22() { propagation_delay.p_compcxx_parent=this /*connect propagation_delay.to_component, */; }
  virtual ~compcxx_SimpleChannel_22() {}
  void		Start();
  void		Stop();
  void		Setup();
...
class compcxx_SHR_15;class compcxx_DuplexTransceiver_17;/*template <class PLD>
*/
...
public:compcxx_SHR_15* p_compcxx_SHR_15;public:compcxx_DuplexTransceiver_17* p_compcxx_DuplexTransceiver_17;};
...
class compcxx_RoutingSim_23 : public compcxx_component, public CostSimEng
{
 public:
  ...
  compcxx_SimpleChannel_22 /*< mac_packet_t > */channel;
...
#line 90 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_22/*<mac_packet_t  >*/::Setup()
{
...
#line 122 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_22/*<mac_packet_t  >*/::Start()
{
}
...
#line 127 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_22/*<mac_packet_t  >*/::Stop()
{
}
...
#line 132 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_22/*<mac_packet_t  >*/::pos_in(const coordinate_t & pos, int id)
{
...
#line 172 "../../phy/simple_channel.h"
/*template <class PACKET>
*/bool compcxx_SimpleChannel_22/*<mac_packet_t  >*/::isNeighbor(
  double	power,
  int		src,
  int		dest)
{
...
#line 181 "../../phy/simple_channel.h"
/*template <class PACKET>
*/bool compcxx_SimpleChannel_22/*<mac_packet_t  >*/::forward ( mac_packet_t  * p, double power, int in, int out, bool flag)
{
...
#line 225 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_22/*<mac_packet_t  >*/::from_phy ( mac_packet_t  * packet, double power, int in)
{   
...
#line 281 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_22/*<mac_packet_t  >*/::depart ( const triple<mac_packet_t  *, double, int> & data , unsigned int index)
{
...
#line 289 "../../phy/simple_channel.h"
/*template <class PACKET>
*/bool compcxx_SimpleChannel_22/*<mac_packet_t  >*/::initSources(
  int		,	
  bool		)	
{
  return true;		
...
#line 297 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_22/*<mac_packet_t  >*/::getSourcePair(
  int		&,
  int		&)
{
  return;
  ...
  trigger_t	&)
{
  ...
  (p_compcxx_DuplexTransceiver_17->from_mac(np));
  SentPackets++;
}
...
*/void compcxx_DuplexTransceiver_17/*<mac_packet_t  >*/::from_channel(mac_packet_t  * p, double power)
{
	...
	else
	{
		bool error = ( recv_power < RXThresh ) ;
	  	(p_compcxx_BcastMAC_16->from_phy( p, error, recv_power ));
    }
}
...
void compcxx_RoutingSim_23::Setup()
{
  ...
  for(i=0;i<NumNodes;i++)
  {
    nodes[i].to_channel_packet_f.Connect(channel,(compcxx_component::SensorNode_to_channel_packet_f_t)&compcxx_SimpleChannel_22::from_phy) /*connect nodes[i].to_channel_packet,channel.from_phy*/;
    nodes[i].to_channel_pos_f.Connect(channel,(compcxx_component::SensorNode_to_channel_pos_f_t)&compcxx_SimpleChannel_22::pos_in) /*connect nodes[i].to_channel_pos,channel.pos_in*/;
    channel.to_phy[i].Connect(nodes[i],(compcxx_component::SimpleChannel_to_phy_f_t)&compcxx_SensorNode_21::from_channel) /*connect channel.to_phy[i],nodes[i].from_channel */;
  }
