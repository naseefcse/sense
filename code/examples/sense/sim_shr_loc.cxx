...
#line 85 "sim_shr_loc.cc"


#line 1 "../../mob/immobile_loc.h"
...
#line 106 "../../mob/immobile_loc.h"
#endif /* immobile_h*/

#line 86 "sim_shr_loc.cc"
...
#line 91 "sim_shr_loc.cc"


#line 1 "../../phy/simple_channel_loc.h"
...
#line 1 "../../phy/../libraries/parseConfig/inc/SimEvent.h"
...
#line 39 "../../phy/simple_channel_loc.h"



#line 279 "../../phy/simple_channel_loc.h"
#endif /* simple_channel_loc_h */

#line 92 "sim_shr_loc.cc"
...
#include "compcxx_sim_shr_loc.h"
class compcxx_SimpleChannelLoc_23;
#line 401 "../../common/cost.h"
/*template <class T> */
#line 401 "../../common/cost.h"
class compcxx_InfiTimer_13 : public compcxx_component, public TimerBase
{
 public:
  struct event_t : public CostEvent { pair< int, SimEvent> data; };
  compcxx_InfiTimer_13();
  virtual ~compcxx_InfiTimer_13();
	
  /*outport void to_component(pair< int, SimEvent> &, unsigned int i)*/;
 
  void activate(CostEvent*event);

  inline unsigned int Set(double t);
  inline unsigned int Set( pair< int, SimEvent> const & data, double t);
  ...
  inline pair< int, SimEvent> & GetData(unsigned int index) { return GetEvent(index)->data; }
  inline void SetData(pair< int, SimEvent> const &d, unsigned int index) { GetEvent(index)->data = d; }
...
public:compcxx_SimpleChannelLoc_23* p_compcxx_parent;};
...
*/
#line 41 "../../phy/simple_channel_loc.h"
class compcxx_SimpleChannelLoc_23 : public compcxx_component, public TypeII
{
 public:
  ...
  class my_SimpleChannelLoc_to_phy_f_t:public compcxx_functor<SimpleChannelLoc_to_phy_f_t>{ public:void	 operator() ( mac_packet_t  *pkt, double power) { for (unsigned int compcxx_i=1;compcxx_i<c.size();compcxx_i++)(c[compcxx_i]->*f[compcxx_i])( pkt,power); return (c[0]->*f[0])( pkt,power);};};compcxx_array<my_SimpleChannelLoc_to_phy_f_t > to_phy;/*outportvoid	to_phy( mac_packet_t  *pkt, double power)*/;
  ...
  compcxx_InfiTimer_13/*< pair< int, SimEvent>>	*/nodeStateChange;
  /*inport */void	doNodeStateChange( const pair< int, SimEvent> &data, unsigned int);

		compcxx_SimpleChannelLoc_23();
  virtual	~compcxx_SimpleChannelLoc_23() {}
  void		Start();
  void		Stop();
  void		Setup();
...
public:compcxx_SHR_16* p_compcxx_SHR_16;};
...
class compcxx_BcastMAC_17;/*template <class T> */
...
class compcxx_Timer_11 : public compcxx_component, public TimerBase
{
 ...
 private:
  CostSimEng* m_simeng;
  event_t m_event;
public:compcxx_BcastMAC_17* p_compcxx_parent;};
...
class compcxx_SHR_16;class compcxx_DuplexTransceiverLoc_18;/*template <class PLD>
*/
#line 118 "../../mac/bcast_mac.h"
class compcxx_BcastMAC_17 : public compcxx_component, public TypeII, public BcastMAC_Struct<net_packet_t* >
{
 public:
    enum MAC_STATE {
      MAC_IDLE        = 0x0000,   
...
public:compcxx_SHR_16* p_compcxx_SHR_16;public:compcxx_DuplexTransceiverLoc_18* p_compcxx_DuplexTransceiverLoc_18;};

class compcxx_ImmobileLoc_21;/*template <class T> */
#line 241 "../../common/cost.h"
class compcxx_Timer_3 : public compcxx_component, public TimerBase
{
 ...
 private:
  CostSimEng* m_simeng;
  event_t m_event;
public:compcxx_ImmobileLoc_21* p_compcxx_parent;};

class compcxx_SensorNode_22;
#line 38 "../../mob/immobile_loc.h"
class compcxx_ImmobileLoc_21 : public compcxx_component, public TypeII
{
 public:
  ...
  compcxx_ImmobileLoc_21() { timer.p_compcxx_parent=this /*connect timer.to_component, */; }
  void		Start();
  void		Stop();
...
public:compcxx_SensorNode_22* p_compcxx_parent;};
...
class compcxx_InfiTimer_5 : public compcxx_component, public TimerBase
{
 ...
 private:
  ...
  CorsaAllocator* m_allocator;
public:compcxx_SHR_16* p_compcxx_parent;};

class compcxx_SHR_16;/*template <class T> */
#line 241 "../../common/cost.h"
...
class compcxx_CBR_15;class compcxx_BcastMAC_17;/*template <class PLD>
*/
#line 111 "../../net/shr.h"
class compcxx_SHR_16 : public compcxx_component, public TypeII, public SHR_Struct<app_packet_t >
{
 public:
  ether_addr_t	MyEtherAddr;
...
public:compcxx_CBR_15* p_compcxx_CBR_15;public:compcxx_BcastMAC_17* p_compcxx_BcastMAC_17;};

class compcxx_BcastMAC_17;class compcxx_PowerManager_20;class compcxx_SensorNode_22;/*template <class PACKET>
*/
#line 35 "../../phy/transceiver_loc.h"
class compcxx_DuplexTransceiverLoc_18 : public compcxx_component, public TypeII
{
 public:
 ...
 private:
  double	Frequency;
  int		ID;
public:compcxx_BcastMAC_17* p_compcxx_BcastMAC_17;public:compcxx_PowerManager_20* p_compcxx_PowerManager_20;public:compcxx_SensorNode_22* p_compcxx_parent;};

class compcxx_PowerManager_20;/*template <class T> */
#line 241 "../../common/cost.h"
class compcxx_Timer_14 : public compcxx_component, public TimerBase
{
 ...
 private:
  CostSimEng* m_simeng;
  event_t m_event;
public:compcxx_PowerManager_20* p_compcxx_parent;};

class compcxx_SimpleBattery_19;class compcxx_SHR_16;
#line 11 "../../energy/power.h"
class compcxx_PowerManager_20 : public compcxx_component, public TypeII, public PM_Struct
{
 public:
  compcxx_PowerManager_20();
  ...
  void		Start();
  void		Stop();
  compcxx_Timer_14/*<trigger_t> */switch_timer;
 private:
  int		m_state; 
  bool		m_switch_on;
  bool		transient;
  ...
  double	downTime;
  double	initTime;
public:compcxx_SimpleBattery_19* p_compcxx_SimpleBattery_19;public:compcxx_SHR_16* p_compcxx_SHR_16;};


#line 93 "sim_shr.h"
class compcxx_SensorNode_22 : public compcxx_component, public TypeII
{
 public:
  compcxx_CBR_15		app;
  compcxx_SHR_16 /*<app_packet_t>		*/net;
  compcxx_BcastMAC_17 /*<net_packet_t*>	*/mac;
  
  
  compcxx_DuplexTransceiverLoc_18 /*< mac_packet_t >	*/phy;
  
  compcxx_SimpleBattery_19	battery;
  
  compcxx_PowerManager_20	pm;
  
  compcxx_ImmobileLoc_21	mob;
...
#line 289 "sim_shr.h"
class compcxx_RoutingSim_24 : public compcxx_component, public CostSimEng
{
 public:
  void		Start();
  void		Stop();
  void		ClearStats();
		compcxx_RoutingSim_24();
  ...
  compcxx_array<compcxx_SensorNode_22 >nodes;
  compcxx_SimpleChannelLoc_23 /*< mac_packet_t > */channel;
...
/*template <class T>
*//*typename */compcxx_InfiTimer_13/*<T>*/::event_t* compcxx_InfiTimer_13/*<pair< int, SimEvent> >*/::GetEvent(unsigned int index)
{
...
#line 464 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_13/*<pair< int, SimEvent> >*/::Set(pair< int, SimEvent> const & data, double time)
{
  int index=GetSlot();
...
#line 478 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_13/*<pair< int, SimEvent> >*/::Set(double time)
{
  int index=GetSlot();
  event_t * e = GetEvent(index);
  assert(e->active==false);
...
#line 491 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_13/*<pair< int, SimEvent> >*/::Cancel(unsigned int index)
{
  event_t * e = GetEvent(index);
  assert(e->active);
...
#line 501 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_13/*<pair< int, SimEvent> >*/::activate(CostEvent*e)
{
  event_t * event = (event_t*)e;
  event->active = false;
  ReleaseSlot(event->index);
  (p_compcxx_parent->doNodeStateChange(event->data,event->index));
}
...
#line 510 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_13/*<pair< int, SimEvent> >*/::GetSlot()
{
...
#line 55 "../../phy/simple_channel_loc.h"

#line 59 "../../phy/simple_channel_loc.h"

#line 99 "../../phy/simple_channel_loc.h"
compcxx_SimpleChannelLoc_23
#line 98 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*//*<PACKET>*/::compcxx_SimpleChannelLoc_23()
{
  NumNodes = 0;
  DumpPackets = false;
  WaveLength = 0;
  ...
  nodeStateChange.p_compcxx_parent=this /*connect nodeStateChange.to_component, */;
  return;
}


#line 114 "../../phy/simple_channel_loc.h"

#line 114 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/void compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::Setup()
{
  bool		status;
  int		node;
  double	time;
...
#line 137 "../../phy/simple_channel_loc.h"

#line 137 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/void compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::Start()
{
  return;
}


#line 143 "../../phy/simple_channel_loc.h"

#line 143 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/void compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::Stop()
{
  return;
}


#line 149 "../../phy/simple_channel_loc.h"

#line 149 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/void compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::pos_in(const coordinate_t & pos, int id)
{
...
#line 157 "../../phy/simple_channel_loc.h"

#line 157 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/bool compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::forward(
  mac_packet_t  *pkt,
  int		in,
  int		out,
  bool		justTesting)
...
#line 194 "../../phy/simple_channel_loc.h"

#line 194 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/void compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::from_phy(
  mac_packet_t  *packet,
  double	,	
  int		in)
{   
...
#line 215 "../../phy/simple_channel_loc.h"

#line 215 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/void compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::depart(
...
#line 228 "../../phy/simple_channel_loc.h"

#line 228 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/bool compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::initSources(
  int		numSources,
  bool		oneSink)
{
...
#line 245 "../../phy/simple_channel_loc.h"

#line 245 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/void compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::getSourcePair(
  int		&src,
  int		&dest)
{
  src = nextSource++;
...
#line 257 "../../phy/simple_channel_loc.h"

#line 257 "../../phy/simple_channel_loc.h"
/*template <class PACKET>
*/void compcxx_SimpleChannelLoc_23/*<mac_packet_t  >*/::doNodeStateChange(
...
void compcxx_CBR_15::create(trigger_t&, int index)
{
    ...
    (p_compcxx_SHR_16->from_transport(p,p.dst_addr,p.data_size));
    SentPackets++;
...
#line 223 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::Start()
{
...
#line 236 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::Stop()
{
}
...
#line 241 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::from_network(
...
#line 271 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::DeferTimer(
  trigger_t	&)
{
  ...
  (p_compcxx_DuplexTransceiverLoc_18->from_mac(np));
  SentPackets++;
}
...
#line 311 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::SendTimer(trigger_t&)
{
  m_state=MAC_IDLE;
  (p_compcxx_SHR_16->from_mac_ack(!m_sr_collision));
}
...
#line 318 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::AckTimer(
  bool		&flag)
{
  m_state=MAC_IDLE;
  (p_compcxx_SHR_16->from_mac_ack(flag));
  return;
}
...
#line 328 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::cancel()
{
  if(m_state==MAC_DEFER)
  {
    defer_timer.Cancel();
...
#line 341 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::from_phy(
  packet_t	*pkt,
  bool		errflag,
  double	power)
{
  ...
  if( recv_timer.Active() )
  {
	...
	DropPacket(pkt,"receive-receive collision");
      ...
      (p_compcxx_SHR_16->from_mac_recv_recv_coll( p1->pld, p2->pld));	
...
#line 415 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::RecvTimer(
  trigger_t	&)
{
...
#line 477 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::RecvData(
  packet_t	*p)
{
  ...
  (p_compcxx_SHR_16->from_mac_data(p->pld,m_rxinf.power));
  p->free(); 
}
...
#line 517 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::StartDefer()
{
...
#line 536 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::ResumeDefer()
{
...
#line 547 "../../mac/bcast_mac.h"
/*template <class PLD>
*/void compcxx_BcastMAC_17/*<net_packet_t* >*/::DropPacket(
  packet_t	*p,
  const char	*reason)
{
...
#line 42 "../../mob/immobile_loc.h"
void	compcxx_ImmobileLoc_21::pos_out( coordinate_t& pos, int id){return (p_compcxx_parent->to_channel_pos( pos,id));}
#line 43 "../../mob/immobile_loc.h"

#line 64 "../../mob/immobile_loc.h"
Visualizer	*compcxx_ImmobileLoc_21::visualizer = NULL;


#line 66 "../../mob/immobile_loc.h"
void compcxx_ImmobileLoc_21::setVisualizer(
  Visualizer	*ptr)
{
  visualizer = ptr;
  return;
...
#line 73 "../../mob/immobile_loc.h"
void compcxx_ImmobileLoc_21::announce_pos(trigger_t&)
{
...
#line 86 "../../mob/immobile_loc.h"
void compcxx_ImmobileLoc_21::Setup()
{
...
#line 96 "../../mob/immobile_loc.h"
void compcxx_ImmobileLoc_21::Start()
{
  timer.Set(0.0);
  return;
}
...
#line 102 "../../mob/immobile_loc.h"
void compcxx_ImmobileLoc_21::Stop()
{
  return;
}
...
#line 150 "../../net/shr.h"
void		compcxx_SHR_16::cancel(){return (p_compcxx_BcastMAC_17->cancel());}
#line 151 "../../net/shr.h"
void		compcxx_SHR_16::to_transport( payload_t &pld){return (p_compcxx_CBR_15->from_transport( pld));}
#line 152 "../../net/shr.h"
void		compcxx_SHR_16::to_mac( packet_t *pkt, unsigned int size,
				double backoff){return (p_compcxx_BcastMAC_17->from_network( pkt,size,backoff));}
#line 156 "../../net/shr.h"
...
#line 297 "../../net/shr.h"
/*template <class PLD> */SHRBackOff	compcxx_SHR_16/*<app_packet_t >*/::backOff;

#line 298 "../../net/shr.h"

#line 298 "../../net/shr.h"
/*template <class PLD> */bool	compcxx_SHR_16/*<app_packet_t >*/::continuousBackOff;

#line 299 "../../net/shr.h"

#line 299 "../../net/shr.h"
/*template <class PLD> */double	compcxx_SHR_16/*<app_packet_t >*/::slotWidth;

#line 300 "../../net/shr.h"

#line 300 "../../net/shr.h"
/*template <class PLD> */double	compcxx_SHR_16/*<app_packet_t >*/::transitionTime;

#line 301 "../../net/shr.h"

#line 301 "../../net/shr.h"
/*template <class PLD> */bool	compcxx_SHR_16/*<app_packet_t >*/::RouteRepairEnabled;

#line 302 "../../net/shr.h"

#line 302 "../../net/shr.h"
/*template <class PLD> */int	compcxx_SHR_16/*<app_packet_t >*/::seq_number_t::maxCounter = 1;

#line 303 "../../net/shr.h"

#line 303 "../../net/shr.h"
/*template <class PLD> */bool	compcxx_SHR_16/*<app_packet_t >*/::doubleMsgPrinted = false;

#line 304 "../../net/shr.h"

#line 304 "../../net/shr.h"
/*template <class PLD> */Visualizer	*compcxx_SHR_16/*<app_packet_t >*/::visualizer = NULL;
...
#line 306 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::setVisualizer(
  Visualizer	*ptr)
{
  visualizer = ptr;
  return;
...
#line 314 "../../net/shr.h"
/*template <class PLD>
*/int compcxx_SHR_16/*<app_packet_t >*/::seq_number_t::getCounter()
{
  return maxCounter;
}
...
#line 320 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::seq_number_t::setCounter(
  int	newCounter)
{
...
#line 328 "../../net/shr.h"
/*template <class PLD>
*/unsigned int compcxx_SHR_16/*<app_packet_t >*/::seq_number_t::hopCount() const
{
  switch( state)
  {
    case Initial:
...
#line 344 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::seq_number_t::hopCount(
  unsigned int	newHC,
  bool		force,	
  bool		print)
{
...
#line 415 "../../net/shr.h"
/*template <class PLD>
*/void *compcxx_SHR_16/*<app_packet_t >*/::createBasicPkt()
{
...
#line 442 "../../net/shr.h"
/*template <class PLD>
*/void *compcxx_SHR_16/*<app_packet_t >*/::createDataPkt(
  payload_t	&pld,
  ether_addr_t	dst,
  unsigned int	size)
{
...
#line 461 "../../net/shr.h"
/*template <class PLD>
*/void *compcxx_SHR_16/*<app_packet_t >*/::createRequestPkt(
  ether_addr_t	dst)
{
  packet_t	*newPkt = (packet_t *) createBasicPkt();
...
#line 479 "../../net/shr.h"
/*template <class PLD>
*/void *compcxx_SHR_16/*<app_packet_t >*/::createReplyPkt(
  ether_addr_t	src,
...
#line 498 "../../net/shr.h"
/*template <class PLD>
*/void *compcxx_SHR_16/*<app_packet_t >*/::createAckPkt(
  ether_addr_t	src_addr,
  ether_addr_t	cur_addr,
  ether_addr_t	pre_addr,
  unsigned int	seq_number,
...
#line 522 "../../net/shr.h"
/*template <class PLD>
*/void *compcxx_SHR_16/*<app_packet_t >*/::createHelloPkt(
...
#line 545 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::seq_number_t::dumpStatic(
  FILE		*fp,
  int		indent,
  int		offset) const
{
...
#line 558 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::seq_number_t::dump(
  FILE		*fp,
  int		dest,
  int		indent,
  int		offset) const
...
#line 585 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::dumpStatic(
  FILE		*fp,
  int		indent,
  int		offset) const
{
...
#line 609 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::dumpCacheStatic(
  FILE		*fp,
  int		indent,
  int		offset) const
{
...
#line 619 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::dump(
  FILE		*fp,
  int		indent,
  int		offset) const
{
...
#line 648 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::dumpCostTable(
  FILE		*fp,
  int		indent,
  int		offset) const
{
...
#line 665 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::setSlotWidth(
  double	sw)
{
  slotWidth = sw;
  return;
...
#line 673 "../../net/shr.h"
/*template <class PLD>
*/double compcxx_SHR_16/*<app_packet_t >*/::getSlotWidth()
{
  return slotWidth;
}
...
#line 679 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::setTransitionTime(
  double	tt)
{
  transitionTime = tt;
  return;
...
#line 687 "../../net/shr.h"
/*template <class PLD>
*/double compcxx_SHR_16/*<app_packet_t >*/::getTransitionTime()
{
...
#line 693 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::setBackOff(
  SHRBackOff	bot)
{
  backOff = bot;
  return;
...
#line 701 "../../net/shr.h"
/*template <class PLD>
*/SHRBackOff compcxx_SHR_16/*<app_packet_t >*/::getBackOff()
{
  return backOff;
}
...
#line 707 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::setContinuousBackOff(
  bool		flag)
{
...
#line 715 "../../net/shr.h"
/*template <class PLD>
*/bool compcxx_SHR_16/*<app_packet_t >*/::getContinuousBackOff()
{
...
#line 721 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::setRouteRepair(
  int	numSteps)
{
  if( numSteps == 0)
...
#line 751 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::Start() 
{
...
#line 780 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::clearStats()
{
  SentPackets = 0;
  SentSuboptimal = 0;
  CanceledPackets = 0;
...
#line 798 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::Stop() 
{
...
#line 806 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::from_transport(
  payload_t	&pld,
  ether_addr_t	&dst,
  unsigned int	size)
{
...
#line 851 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::AddToSendQueue(
  packet_t	*pkt)
{
...
#line 888 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::SendPacket(
  packet_t	*pkt)
{
...
#line 911 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::PktDelayTimer(
  packet_t	*pkt,
  unsigned int)
{
...
#line 929 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::AssignSeqNumber(
  packet_t	*pkt)
{
...
#line 976 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::SendToMac(
  packet_t	*pkt)
{
  m_mac_busy = true;
  if( transitionTime != 0)
  {
    ...
    (p_compcxx_BcastMAC_17->from_network( pkt, pkt->hdr.size, 0));
  return;
}
...
#line 999 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::TransitionTimer(
  trigger_t	&)
{
  
  (p_compcxx_BcastMAC_17->from_network( transitionPkt, transitionPkt->hdr.size, 0));
  transitionPkt = 0;
  return;
}
...
#line 1016 "../../net/shr.h"
/*template <class PLD>
*/bool compcxx_SHR_16/*<app_packet_t >*/::updateHopCountInCache(
  ether_addr_t	dst,
...
#line 1060 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::HelloTimer(
  trigger_t	&)
{
#ifdef	USE_CONFIG_FILE
...
#line 1074 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::scheduleHELLO(
  double	time)
{
#ifdef	USE_CONFIG_FILE
...
#line 1099 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::from_pm_node_up()
{
...
#line 1112 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::generateHELLO()
{
  cache_t::iterator iter;
  ether_addr_t	dest;
...
#line 1139 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::receiveHelloPacket(
  packet_t	*pkt)
{
  cache_t::iterator	iter;
...
#line 1168 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::from_mac_data(
  packet_t	*pkt,
  double	power)
{
...
#line 1457 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::forwardAsFlood(
  packet_t	*pkt)
{
...
#line 1486 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::receiveAck(
  packet_t	*ackPkt)
{
...
#line 1528 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::receiveDataRep(
  packet_t	*rcvdPkt)
{
...
#line 1569 "../../net/shr.h"
/*template <class PLD>
*/void *compcxx_SHR_16/*<app_packet_t >*/::getFromAckList(
  packet_t	*pkt)
{
  packet_queue_t::iterator iter;
...
#line 1586 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::removeFromAckList(
  packet_t	*pkt,
  bool		cancelTimer)
{
...
#line 1601 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::doRouteRepair(
  packet_t	*pktFromList,
  packet_t	*rcvdPkt)
{
...
#line 1631 "../../net/shr.h"
/*template <class PLD>
*/int compcxx_SHR_16/*<app_packet_t >*/::getHCFromCostTable(
  int		addr)
{
  cache_t::iterator	iter;
...
#line 1646 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::from_mac_recv_recv_coll( packet_t *pkt1, packet_t *pkt2)
{
...
#line 1657 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::CancelPacket(
  ether_addr_t	&src,
  unsigned int	seq_number)
{
...
#line 1728 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::from_mac_ack(
  bool		flag)
{
  bool		testQueue = true;
...
#line 1802 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::AckTimer(
  packet_t	*pkt,
  unsigned int)
{
...
#line 1820 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::SendAck(
  ether_addr_t	src_addr,
  ether_addr_t	cur_addr,
  ether_addr_t	pre_addr,
  unsigned int	seq_number,
...
#line 1840 "../../net/shr.h"
/*template <class PLD>
*/void compcxx_SHR_16/*<app_packet_t >*/::CheckBuffer(
  ether_addr_t	src_addr,
  unsigned int	expected_hop)
{
...
#line 64 "../../phy/transceiver_loc.h"
/*template <class PACKET>
*/void compcxx_DuplexTransceiverLoc_18/*<mac_packet_t  >*/::Start()
{
  return;
}
...
#line 70 "../../phy/transceiver_loc.h"
/*template <class PACKET>
*/void compcxx_DuplexTransceiverLoc_18/*<mac_packet_t  >*/::Stop()
{
  return;
}
...
#line 76 "../../phy/transceiver_loc.h"
/*template <class PACKET>
*/void compcxx_DuplexTransceiverLoc_18/*<mac_packet_t  >*/::from_mac(
  mac_packet_t  *pkt)
{
  double now = SimTime();
  ...
  if( (p_compcxx_PowerManager_20->switch_state( PM_Struct::IDLE, now + pkt->hdr.tx_time) )<= 0.0)
  {
    pkt->free();
    return;
  } 
...
#line 98 "../../phy/transceiver_loc.h"
/*template <class PACKET>
*/void compcxx_DuplexTransceiverLoc_18/*<mac_packet_t  >*/::from_channel(
  mac_packet_t  *pkt,
  double	power)
{
  double now = SimTime();
  ...
  (p_compcxx_BcastMAC_17->from_phy( pkt, false, 1.0));
  return;
}
...
compcxx_PowerManager_20::compcxx_PowerManager_20()
{
  upTime = 1.0;
  downTime = 0.0;
  initTime = 0.0;
...
void compcxx_PowerManager_20::failureStats(
...
void compcxx_PowerManager_20::power_switch(
  trigger_t	&)
{
  ...
  {
    m_state = OFF;
    (p_compcxx_SimpleBattery_19->power_in( 0.0, SimTime()));
    m_switch_on = false;
    if( transient == true)
  ...
  {
    m_state = IDLE;
    (p_compcxx_SimpleBattery_19->power_in( IdlePower, SimTime()));
    m_switch_on = true;
    (p_compcxx_SHR_16->from_pm_node_up());		
...
double compcxx_PowerManager_20::switch_state(
  int		state,
  double	time) 
{
  double	power = 0.0;	
...
#line 124 "sim_shr.h"
void compcxx_SensorNode_22::to_channel_packet(mac_packet_t* packet, double power, int id){return (to_channel_packet_f(packet,power,id));}
#line 125 "sim_shr.h"
void compcxx_SensorNode_22::from_channel(mac_packet_t* packet, double power){return (phy.from_channel(packet,power));}
#line 126 "sim_shr.h"
void compcxx_SensorNode_22::to_channel_pos(coordinate_t& pos, int id){return (to_channel_pos_f(pos,id));}
#line 129 "sim_shr.h"
compcxx_SensorNode_22::~compcxx_SensorNode_22()
{
}


#line 133 "sim_shr.h"
void compcxx_SensorNode_22::Start()
{
}


#line 137 "sim_shr.h"
void compcxx_SensorNode_22::Stop()
{
}
...
#line 144 "sim_shr.h"
void compcxx_SensorNode_22::Setup(
  double	txPower,
  double	lambda)
{
  ...
  app.p_compcxx_SHR_16=&net /*connect app.to_transport, net.from_transport*/;
  net.p_compcxx_CBR_15=&app /*connect net.to_transport, app.from_transport*/;
    
  mac.p_compcxx_SHR_16=&net /*connect mac.to_network_data, net.from_mac_data*/;
  mac.p_compcxx_SHR_16=&net /*connect mac.to_network_ack, net.from_mac_ack*/;
  net.p_compcxx_BcastMAC_17=&mac /*connect net.to_mac, mac.from_network*/;
  net.p_compcxx_BcastMAC_17=&mac /*connect net.cancel, mac.cancel*/;
  mac.p_compcxx_SHR_16=&net /*connect mac.to_network_recv_recv_coll, net.from_mac_recv_recv_coll*/;
    
  mac.p_compcxx_DuplexTransceiverLoc_18=&phy /*connect mac.to_phy, phy.from_mac*/;
  phy.p_compcxx_BcastMAC_17=&mac /*connect phy.to_mac, mac.from_phy*/;
  ...
  pm.p_compcxx_SHR_16=&net /*connect pm.from_pm_node_up, net.from_pm_node_up*/;
...
#line 358 "sim_shr.h"
compcxx_RoutingSim_24::compcxx_RoutingSim_24()
{
  NumConnections = 1;
  PacketSize = 1000;
  StopTime( 1000);
...
#line 386 "sim_shr.h"
void compcxx_RoutingSim_24::Start()
{
  return;
}
...
#line 391 "sim_shr.h"
void compcxx_RoutingSim_24::ClearStats()
{
  int		i;
...
#line 405 "sim_shr.h"
void compcxx_RoutingSim_24::GenerateHELLO(
  int		id)
{
...
#line 416 "sim_shr.h"
void compcxx_RoutingSim_24::Stop()
{
...
#line 563 "sim_shr.h"
void compcxx_RoutingSim_24::packetTimes(
  int		source,
  int		dest)
{
...
#line 577 "sim_shr.h"
void compcxx_RoutingSim_24::Setup()
{
  int i;
  ...
  for(i=0;i<NumNodes;i++)
  {
    nodes[i].to_channel_packet_f.Connect(channel,(compcxx_component::SensorNode_to_channel_packet_f_t)&compcxx_SimpleChannelLoc_23::from_phy) /*connect nodes[i].to_channel_packet,channel.from_phy*/;
    nodes[i].to_channel_pos_f.Connect(channel,(compcxx_component::SensorNode_to_channel_pos_f_t)&compcxx_SimpleChannelLoc_23::pos_in) /*connect nodes[i].to_channel_pos,channel.pos_in*/;
    channel.to_phy[i].Connect(nodes[i],(compcxx_component::SimpleChannelLoc_to_phy_f_t)&compcxx_SensorNode_22::from_channel) /*connect channel.to_phy[i],nodes[i].from_channel */;
  }
