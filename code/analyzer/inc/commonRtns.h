...
#ifndef	_commonRtns_h_
#define _commonRtns_h_

extern void	printInt( int);
extern void	printNodeInfo( const NodeList::value_type info);
extern void	printCTInfo( const CTList::value_type info);

#endif	// _commonRtns_h_
