...
public:compcxx_Flooding_20* p_compcxx_Flooding_20;};
...
class compcxx_FIFOACK3_26;class compcxx_Flooding_20;class compcxx_DuplexTransceiver_22;/*template <class PLD>
*/
...
public:compcxx_FIFOACK3_26* p_compcxx_FIFOACK3_26;public:compcxx_Flooding_20* p_compcxx_Flooding_20;public:compcxx_DuplexTransceiver_22* p_compcxx_DuplexTransceiver_22;};
...
class compcxx_InfiTimer_4 : public compcxx_component, public TimerBase
{
 ...
 private:
  ...
  CorsaAllocator* m_allocator;
public:compcxx_Flooding_20* p_compcxx_parent;};

class compcxx_CBR_19;class compcxx_FIFOACK3_26;/*template <class PLD>
*/
#line 113 "../../net/flooding.h"
class compcxx_Flooding_20 : public compcxx_component, public TypeII, public Flooding_Struct<app_packet_t >
{
 public:
...
class compcxx_SimpleBattery_23;class compcxx_Flooding_20;
...
class compcxx_PowerManager_24 : public compcxx_component, public TypeII, public PM_Struct
{
 ...
 private:
  ...
  double	downTime;
  double	initTime;
public:compcxx_SimpleBattery_23* p_compcxx_SimpleBattery_23;public:compcxx_Flooding_20* p_compcxx_Flooding_20;};

class compcxx_MAC80211_21;class compcxx_Flooding_20;/*template < class T1, class T2, class T3 >
*/
...
public:compcxx_MAC80211_21* p_compcxx_MAC80211_21;public:compcxx_Flooding_20* p_compcxx_Flooding_20;};
...
public:
    ...
    compcxx_CBR_19 app;
    compcxx_Flooding_20 /*<app_packet_t> */net;
...
void compcxx_CBR_19::create(trigger_t&, int index)
{
    ...
    (p_compcxx_Flooding_20->from_transport(p,p.dst_addr,p.data_size));
    SentPackets++;
...
*/void compcxx_MAC80211_21/*<net_packet_t* >*/::RecvData(packet_t* p)
{
    ...
    (p_compcxx_Flooding_20->from_mac_data(p->pld,p->hdr.dh_da));
    p->free(); 
}
...
#line 183 "../../net/flooding.h"

#line 252 "../../net/flooding.h"
compcxx_Flooding_20
#line 251 "../../net/flooding.h"
/*template <class PLD>
*//*<PLD>*/::compcxx_Flooding_20()
{
	delay.p_compcxx_parent=this /*connect delay.to_component, */;
}

#line 257 "../../net/flooding.h"
compcxx_Flooding_20
#line 256 "../../net/flooding.h"
/*template <class PLD>
*//*<PLD>*/::~compcxx_Flooding_20()
{
}
...
#line 261 "../../net/flooding.h"

#line 261 "../../net/flooding.h"
/*template <class PLD>
*/void compcxx_Flooding_20/*<app_packet_t >*/::Start() 
{
    m_mac_busy=false;
    m_seq_number=1u;
...
#line 271 "../../net/flooding.h"

#line 271 "../../net/flooding.h"
/*template <class PLD>
*/void compcxx_Flooding_20/*<app_packet_t >*/::Stop() 
{
...
#line 285 "../../net/flooding.h"

#line 285 "../../net/flooding.h"
/*template <class PLD>
*/void compcxx_Flooding_20/*<app_packet_t >*/::from_transport( payload_t& pld, ether_addr_t& dst, unsigned int size)
{
    ...
    (p_compcxx_FIFOACK3_26->in(p,ether_addr_t::BROADCAST,size));
}
...
#line 330 "../../net/flooding.h"

#line 330 "../../net/flooding.h"
/*template <class PLD>
*/void compcxx_Flooding_20/*<app_packet_t >*/::from_mac_data (packet_t* pkt, ether_addr_t& dst)
{
  ether_addr_t src;
  ...
  if( !iter->second.check(pkt->hdr.seq_number) )
  {
    ...
    if(pkt->access_pld().dst_addr==MyEtherAddr||pkt->access_pld().dst_addr==ether_addr_t::BROADCAST)
    {
      ...
      pkt->inc_pld_ref();
      (p_compcxx_CBR_19->from_transport(pkt->pld));
    }
    else  
    {
...
#line 393 "../../net/flooding.h"

#line 393 "../../net/flooding.h"
/*template <class PLD>
*/void compcxx_Flooding_20/*<app_packet_t >*/::from_mac_ack(bool)
{
    m_mac_busy=false;
}
...
#line 403 "../../net/flooding.h"

#line 403 "../../net/flooding.h"
/*template <class PLD>
*/void compcxx_Flooding_20/*<app_packet_t >*/::from_pm_node_up()
{
  return;
}


#line 409 "../../net/flooding.h"

#line 409 "../../net/flooding.h"
/*template <class PLD>
*/void compcxx_Flooding_20/*<app_packet_t >*/::depart(packet_t* p, unsigned int i)
{
	m_mac_busy=true;
	(p_compcxx_FIFOACK3_26->in(p,ether_addr_t::BROADCAST,p->hdr.size));
}
  ...
  trigger_t	&)
{
  ...
  else		
  {
    ...
    m_switch_on = true;
    (p_compcxx_Flooding_20->from_pm_node_up());		
...
*/void compcxx_FIFOACK3_26 /*<net_packet_t* ,ether_addr_t ,unsigned int >*/::in (net_packet_t* const& t1, ether_addr_t const& t2, unsigned int const& t3)
{
	...
	(p_compcxx_Flooding_20->from_mac_ack(true));
    }
    else
    {
	(p_compcxx_MAC80211_21->from_network(t1,t2,t3));
...
*/void compcxx_FIFOACK3_26 /*<net_packet_t* ,ether_addr_t ,unsigned int > */:: next (const bool& flag)
{
    ...
    {
	(p_compcxx_Flooding_20->from_mac_ack(flag));
    }
    return;
}
...
void compcxx_SensorNode_27::Setup()
{
    ...
    app.p_compcxx_Flooding_20=&net /*connect app.to_transport, net.from_transport*/;
    ...
    queue.p_compcxx_Flooding_20=&net /*connect queue.ack, net.from_mac_ack*/;
    mac.p_compcxx_Flooding_20=&net /*connect mac.to_network_data, net.from_mac_data */;
    ...
    pm.p_compcxx_Flooding_20=&net /*connect pm.from_pm_node_up, net.from_pm_node_up*/;
