/*************************************************************************
 *   @<title> SHR Protocol Simulation (Distance Channel) </title>@
 *
 ...
 *
 *
 * @<h1> SHR Protocol Simulation (Distance Channel) </h1>@
 *
...
#cxxdef	ChannelType	SimpleChannelDist
...
#include "../../phy/simple_channel_dist.h"
