...
public:compcxx_DSRI_20* p_compcxx_DSRI_20;};
...
class compcxx_FIFOACK3_26;class compcxx_DSRI_20;class compcxx_DuplexTransceiver_22;/*template <class PLD>
*/
...
public:compcxx_FIFOACK3_26* p_compcxx_FIFOACK3_26;public:compcxx_DSRI_20* p_compcxx_DSRI_20;public:compcxx_DuplexTransceiver_22* p_compcxx_DuplexTransceiver_22;};
...
/*template <class T> */
#line 401 "../../common/cost.h"
class compcxx_InfiTimer_9 : public compcxx_component, public TimerBase
{
 public:
  struct event_t : public CostEvent { pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  data; };
  compcxx_InfiTimer_9();
  virtual ~compcxx_InfiTimer_9();
 ...
 private:
  ...
  CorsaAllocator* m_allocator;
public:compcxx_DSRI_20* p_compcxx_parent;};

class compcxx_CBR_19;class compcxx_FIFOACK3_26;/*template <class PLD>
*/
#line 91 "../../net/dsri.h"
class compcxx_DSRI_20 : public compcxx_component, public TypeII, public DSRI_Struct<app_packet_t >
{
public:
    ...
    compcxx_InfiTimer_9/*<pair<DSRI_Struct<app_packet_t >::packet_t*,ether_addr_t> > */to_mac_delay;
    ...
    compcxx_DSRI_20() { to_mac_delay.p_compcxx_parent=this /*connect to_mac_delay.to_component, */;  }
    virtual ~compcxx_DSRI_20() {};
    void Start();
    void Stop();
...
class compcxx_SimpleBattery_23;class compcxx_DSRI_20;
...
class compcxx_PowerManager_24 : public compcxx_component, public TypeII, public PM_Struct
{
 ...
 private:
  ...
  double	downTime;
  double	initTime;
public:compcxx_SimpleBattery_23* p_compcxx_SimpleBattery_23;public:compcxx_DSRI_20* p_compcxx_DSRI_20;};

class compcxx_MAC80211_21;class compcxx_DSRI_20;/*template < class T1, class T2, class T3 >
*/
...
public:compcxx_MAC80211_21* p_compcxx_MAC80211_21;public:compcxx_DSRI_20* p_compcxx_DSRI_20;};
...
public:
    ...
    compcxx_CBR_19 app;
    compcxx_DSRI_20 /*<app_packet_t> */net;
...
void compcxx_CBR_19::create(trigger_t&, int index)
{
    ...
    (p_compcxx_DSRI_20->from_transport(p,p.dst_addr,p.data_size));
    SentPackets++;
...
*/void compcxx_MAC80211_21/*<net_packet_t* >*/::RecvData(packet_t* p)
{
    ...
    (p_compcxx_DSRI_20->from_mac_data(p->pld,p->hdr.dh_da));
    p->free(); 
}
...
#line 448 "../../common/cost.h"
/*template <class T>
*//*typename */compcxx_InfiTimer_9/*<T>*/::event_t* compcxx_InfiTimer_9/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::GetEvent(unsigned int index)
{
  if (index>=m_events.size())
  {
    for (unsigned int i=m_events.size();i<=index;i++)
...
#line 464 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_9/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::Set(pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  const & data, double time)
{
  int index=GetSlot();
  event_t * e = GetEvent(index);
  assert(e->active==false);
...
#line 478 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_9/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::Set(double time)
{
  int index=GetSlot();
  event_t * e = GetEvent(index);
  assert(e->active==false);
...
#line 491 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_9/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::Cancel(unsigned int index)
{
  event_t * e = GetEvent(index);
  assert(e->active);
  m_simeng->CancelEvent(e);
...
#line 501 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_9/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::activate(CostEvent*e)
{
  event_t * event = (event_t*)e;
  event->active = false;
  ReleaseSlot(event->index);
...
#line 510 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_9/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::GetSlot()
{
  if(m_free_slots.empty())
    GetEvent(m_events.size()*2-1);
  int i=m_free_slots.back();
...
#line 104 "../../net/dsri.h"
void compcxx_DSRI_20::to_transport( payload_t& pld ){return (p_compcxx_CBR_19->from_transport( pld ));}
#line 105 "../../net/dsri.h"
void compcxx_DSRI_20::to_mac(packet_t* pkt, ether_addr_t& dst, unsigned int size){return (p_compcxx_FIFOACK3_26->in(pkt,dst,size));}
#line 107 "../../net/dsri.h"
...
#line 138 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::Start() 
{	
    m_rreq_id=0;
    SentPackets=RecvPackets=0;
}
...
#line 145 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::Stop() 
{
...
#line 154 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::from_transport( payload_t& pld, ether_addr_t& dst_addr, unsigned int size)
{
    ...
    
    {
    	...
    	SentPackets++;
	    (p_compcxx_FIFOACK3_26->in(new_p, new_p->hdr.srcrt.get_addr(0), new_p->hdr.size));
    }  
    else 
    {
...
#line 182 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::from_mac_ack (bool)
{
  return;
}	
...
#line 192 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::from_pm_node_up()
{
  return;
}
...
#line 198 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::from_mac_data (packet_t* packet, ether_addr_t& dst_addr)
{
...
#line 222 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::receive_data(packet_t* p)
{
...
#line 245 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::init_rreq(ether_addr_t dst)
{
    packet_t* new_p = packet_t::alloc();
    new_p->hdr.type = RREQ;
...
#line 263 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::receive_rreq(packet_t* p)
{
...
#line 310 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::init_rrep(packet_t* p)
{
    packet_t* new_p = packet_t::alloc();
    new_p->hdr.type = RREP;
    ...
    SentPackets++;
    (p_compcxx_FIFOACK3_26->in(new_p, new_p->hdr.srcrt.get_addr(p->hdr.srcrt.get_hops()-1),new_p->hdr.size)); 
}
...
#line 325 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::receive_rrep(packet_t* p)
{
    ether_addr_t myaddr=MyEtherAddr;
    ...
    if(myaddr!=p->hdr.dst_addr) 
    {
	    ...
	    assert(index>0);
	    SentPackets++;
	    (p_compcxx_FIFOACK3_26->in(new_p, new_p->hdr.srcrt.get_addr(index-1), new_p->hdr.size));
    }    
    else
    {
	    assert(index==0);
...
#line 381 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_20/*<app_packet_t >*/::to_mac_depart(const pair<packet_t*,ether_addr_t>&p, unsigned int i)
{
  ...
  trigger_t	&)
{
  ...
  else		
  {
    ...
    m_switch_on = true;
    (p_compcxx_DSRI_20->from_pm_node_up());		
...
*/void compcxx_FIFOACK3_26 /*<net_packet_t* ,ether_addr_t ,unsigned int >*/::in (net_packet_t* const& t1, ether_addr_t const& t2, unsigned int const& t3)
{
	...
	(p_compcxx_DSRI_20->from_mac_ack(true));
    }
    else
    {
	(p_compcxx_MAC80211_21->from_network(t1,t2,t3));
...
*/void compcxx_FIFOACK3_26 /*<net_packet_t* ,ether_addr_t ,unsigned int > */:: next (const bool& flag)
{
    ...
    {
	(p_compcxx_DSRI_20->from_mac_ack(flag));
    }
    return;
}
...
void compcxx_SensorNode_27::Setup()
{
    ...
    app.p_compcxx_DSRI_20=&net /*connect app.to_transport, net.from_transport*/;
    ...
    queue.p_compcxx_DSRI_20=&net /*connect queue.ack, net.from_mac_ack*/;
    mac.p_compcxx_DSRI_20=&net /*connect mac.to_network_data, net.from_mac_data */;
    ...
    pm.p_compcxx_DSRI_20=&net /*connect pm.from_pm_node_up, net.from_pm_node_up*/;
