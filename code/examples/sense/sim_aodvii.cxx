...
typedef AODVII_Struct<app_packet_t>::packet_t net_packet_t;
...
public:compcxx_AODVII_20* p_compcxx_AODVII_20;};
...
class compcxx_FIFOACK3_26;class compcxx_AODVII_20;class compcxx_DuplexTransceiver_22;/*template <class PLD>
*/
...
public:compcxx_FIFOACK3_26* p_compcxx_FIFOACK3_26;public:compcxx_AODVII_20* p_compcxx_AODVII_20;public:compcxx_DuplexTransceiver_22* p_compcxx_DuplexTransceiver_22;};
...
class compcxx_AODVII_20;/*template <class T> */
#line 241 "../../common/cost.h"
class compcxx_Timer_7 : public compcxx_component, public TimerBase
{
 ...
 private:
  CostSimEng* m_simeng;
  event_t m_event;
public:compcxx_AODVII_20* p_compcxx_parent;};
...
{
 public:
  struct event_t : public CostEvent { ether_addr_t data; };
  compcxx_InfiTimer_8();
  virtual ~compcxx_InfiTimer_8();
	
  /*outport void to_component(ether_addr_t &, unsigned int i)*/;
 
  void activate(CostEvent*event);

  inline unsigned int Set(double t);
  inline unsigned int Set( ether_addr_t const & data, double t);
  inline void Cancel (unsigned int index);
  inline event_t* GetEvent(unsigned int index);

  inline bool Active(unsigned int index) { return GetEvent(index)->active; }
  inline double GetTime(unsigned int index) { return GetEvent(index)->time; }
  inline ether_addr_t & GetData(unsigned int index) { return GetEvent(index)->data; }
  inline void SetData(ether_addr_t const &d, unsigned int index) { GetEvent(index)->data = d; }
...
{
 public:
  struct event_t : public CostEvent { AODVII_Struct<app_packet_t>::packet_t*  data; };
  compcxx_InfiTimer_6();
  virtual ~compcxx_InfiTimer_6();
	
  /*outport void to_component(AODVII_Struct<app_packet_t>::packet_t*  &, unsigned int i)*/;
 
  void activate(CostEvent*event);

  inline unsigned int Set(double t);
  inline unsigned int Set( AODVII_Struct<app_packet_t>::packet_t*  const & data, double t);
  inline void Cancel (unsigned int index);
  inline event_t* GetEvent(unsigned int index);

  inline bool Active(unsigned int index) { return GetEvent(index)->active; }
  inline double GetTime(unsigned int index) { return GetEvent(index)->time; }
  inline AODVII_Struct<app_packet_t>::packet_t*  & GetData(unsigned int index) { return GetEvent(index)->data; }
  inline void SetData(AODVII_Struct<app_packet_t>::packet_t*  const &d, unsigned int index) { GetEvent(index)->data = d; }
...
*/
#line 118 "../../net/aodvii.h"
class compcxx_AODVII_20 : public compcxx_component, public TypeII, public AODVII_Struct<app_packet_t >
{
public:
    ...
    compcxx_InfiTimer_6/*< AODVII_Struct<app_packet_t >::packet_t* > */to_mac_delay;
    ...
    compcxx_Timer_7 /*< trigger_t> */hello_timer;
    /*inport */inline void HelloTimer(trigger_t&);
    compcxx_InfiTimer_8 /*< ether_addr_t> */repair_timer;
    /*inport */inline void RepairTimer(ether_addr_t&, unsigned int i);

    compcxx_AODVII_20() 
    {
	to_mac_delay.p_compcxx_parent=this /*connect to_mac_delay.to_component, */;  
	hello_timer.p_compcxx_parent=this /*connect hello_timer.to_component, */;
	repair_timer.p_compcxx_parent=this /*connect repair_timer.to_component, */;
    }

    virtual ~compcxx_AODVII_20() {};
    void Start();				        
    void Stop();				        
 ...
 protected:
    void init_rreq(ether_addr_t, int, int);       
...
class compcxx_SimpleBattery_23;class compcxx_AODVII_20;
...
class compcxx_PowerManager_24 : public compcxx_component, public TypeII, public PM_Struct
{
 ...
 private:
  ...
  double	downTime;
  double	initTime;
public:compcxx_SimpleBattery_23* p_compcxx_SimpleBattery_23;public:compcxx_AODVII_20* p_compcxx_AODVII_20;};

class compcxx_MAC80211_21;class compcxx_AODVII_20;/*template < class T1, class T2, class T3 >
*/
...
public:compcxx_MAC80211_21* p_compcxx_MAC80211_21;public:compcxx_AODVII_20* p_compcxx_AODVII_20;};
...
public:
    ...
    compcxx_CBR_19 app;
    compcxx_AODVII_20 /*<app_packet_t> */net;
...
void compcxx_CBR_19::create(trigger_t&, int index)
{
    ...
    (p_compcxx_AODVII_20->from_transport(p,p.dst_addr,p.data_size));
    SentPackets++;
...
*/void compcxx_MAC80211_21/*<net_packet_t* >*/::RecvData(packet_t* p)
{
    ...
    (p_compcxx_AODVII_20->from_mac_data(p->pld,p->hdr.dh_da));
    p->free(); 
}
...
#line 448 "../../common/cost.h"
/*template <class T>
*//*typename */compcxx_InfiTimer_8/*<T>*/::event_t* compcxx_InfiTimer_8/*<ether_addr_t >*/::GetEvent(unsigned int index)
{
  if (index>=m_events.size())
  {
    for (unsigned int i=m_events.size();i<=index;i++)
...
#line 464 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_8/*<ether_addr_t >*/::Set(ether_addr_t const & data, double time)
{
  int index=GetSlot();
  event_t * e = GetEvent(index);
  assert(e->active==false);
...
#line 478 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_8/*<ether_addr_t >*/::Set(double time)
{
  int index=GetSlot();
  event_t * e = GetEvent(index);
  assert(e->active==false);
...
#line 491 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_8/*<ether_addr_t >*/::Cancel(unsigned int index)
{
  event_t * e = GetEvent(index);
  assert(e->active);
  m_simeng->CancelEvent(e);
...
#line 501 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_8/*<ether_addr_t >*/::activate(CostEvent*e)
{
  event_t * event = (event_t*)e;
  event->active = false;
  ReleaseSlot(event->index);
  (p_compcxx_parent->RepairTimer(event->data,event->index));
}
...
#line 510 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_8/*<ether_addr_t >*/::GetSlot()
{
  if(m_free_slots.empty())
    GetEvent(m_events.size()*2-1);
  int i=m_free_slots.back();
...
#line 448 "../../common/cost.h"
/*template <class T>
*//*typename */compcxx_InfiTimer_6/*<T>*/::event_t* compcxx_InfiTimer_6/*<AODVII_Struct<app_packet_t>::packet_t*  >*/::GetEvent(unsigned int index)
{
  if (index>=m_events.size())
  {
    for (unsigned int i=m_events.size();i<=index;i++)
...
#line 464 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_6/*<AODVII_Struct<app_packet_t>::packet_t*  >*/::Set(AODVII_Struct<app_packet_t>::packet_t*  const & data, double time)
{
  int index=GetSlot();
  event_t * e = GetEvent(index);
  assert(e->active==false);
...
#line 478 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_6/*<AODVII_Struct<app_packet_t>::packet_t*  >*/::Set(double time)
{
  int index=GetSlot();
  event_t * e = GetEvent(index);
  assert(e->active==false);
...
#line 491 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_6/*<AODVII_Struct<app_packet_t>::packet_t*  >*/::Cancel(unsigned int index)
{
  event_t * e = GetEvent(index);
  assert(e->active);
  m_simeng->CancelEvent(e);
...
#line 501 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_6/*<AODVII_Struct<app_packet_t>::packet_t*  >*/::activate(CostEvent*e)
{
  event_t * event = (event_t*)e;
  event->active = false;
  ReleaseSlot(event->index);
...
#line 510 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_6/*<AODVII_Struct<app_packet_t>::packet_t*  >*/::GetSlot()
{
  if(m_free_slots.empty())
    GetEvent(m_events.size()*2-1);
  int i=m_free_slots.back();
...
#line 131 "../../net/aodvii.h"
void compcxx_AODVII_20::to_transport( payload_t& pld ){return (p_compcxx_CBR_19->from_transport( pld ));}
#line 132 "../../net/aodvii.h"
void compcxx_AODVII_20::to_mac(packet_t* pkt, ether_addr_t& dst, unsigned int size){return (p_compcxx_FIFOACK3_26->in(pkt,dst,size));}
#line 138 "../../net/aodvii.h"

#line 141 "../../net/aodvii.h"

#line 143 "../../net/aodvii.h"

#line 203 "../../net/aodvii.h"

#line 203 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::Start()
{
    m_seq_num = 1;
    m_req_id = 0;
    m_data_packet_id = 1;
...
#line 219 "../../net/aodvii.h"

#line 219 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::Stop()
{
...
#line 232 "../../net/aodvii.h"

#line 232 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::from_transport( payload_t& pld, ether_addr_t& dst_addr, unsigned int size)
{    
...
#line 264 "../../net/aodvii.h"

#line 264 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::from_mac_data (packet_t* packet, ether_addr_t& dst_addr)
{
...
#line 303 "../../net/aodvii.h"

#line 303 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::receive_data(packet_t* p)
{
...
#line 356 "../../net/aodvii.h"

#line 356 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::init_rreq(ether_addr_t dst, int ttl, int seq_num)
{
    packet_t* new_p = packet_t::alloc();
...
#line 384 "../../net/aodvii.h"

#line 384 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::receive_rreq(packet_t* p)
{
...
#line 481 "../../net/aodvii.h"

#line 481 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::forward_rreq(packet_t* p, int max_seq_num)
{
    if(p->hdr.TTL > 1) 
    {
	packet_t* new_p = packet_t::alloc();
...
#line 502 "../../net/aodvii.h"

#line 502 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::receive_rrep(packet_t* p)
{
    UpdateRoutingTable(p);
...
#line 550 "../../net/aodvii.h"

#line 550 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::to_mac_depart(packet_t*&p, unsigned int)
{
    BufferPacket(p);
}


#line 556 "../../net/aodvii.h"

#line 556 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::prepare_rerr(bool send, ether_addr_t dst_addr, int dst_seq)
{
...
#line 592 "../../net/aodvii.h"

#line 592 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::init_rerr(ether_addr_t neighbor)
{
...
#line 609 "../../net/aodvii.h"

#line 609 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::receive_rerr(packet_t* p)
{
    routing_table_t::iterator iter;
...
#line 629 "../../net/aodvii.h"

#line 629 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::SendDataPacket(packet_t* p, ether_addr_t dst, route_entry_t& route, unsigned int size)
{
...
#line 669 "../../net/aodvii.h"

#line 669 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::HelloTimer(trigger_t& )
{
    simtime_t now = SimTime();
...
#line 687 "../../net/aodvii.h"

#line 687 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::UpdateRoutingTable(packet_t* pkt)
{
...
#line 725 "../../net/aodvii.h"

#line 725 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::CheckBuffer(ether_addr_t& dst_addr)
{
...
#line 749 "../../net/aodvii.h"

#line 749 "../../net/aodvii.h"
/*template <class PLD>
*/bool compcxx_AODVII_20/*<app_packet_t >*/::SendPacket(packet_t* pkt)
{
	...
	else
	{
		...
		pkt->inc_ref();
		m_active_packet=pkt;
		(p_compcxx_FIFOACK3_26->in(pkt,iter->second.next_hop,pkt->hdr.size));
	    }
	}
    }
    else
	...
	pkt->inc_ref();
	m_active_packet=pkt;
	(p_compcxx_FIFOACK3_26->in(pkt,ether_addr_t::BROADCAST,pkt->hdr.size));
    }
    return true;

}

#line 789 "../../net/aodvii.h"

#line 789 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::BufferPacket(packet_t* pkt)
{
    if(m_mac_busy==false)
    {
	m_active_packet=pkt;
...
#line 808 "../../net/aodvii.h"

#line 808 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::RepairLink(const ether_addr_t& src_addr, const ether_addr_t& dst_addr, route_entry_t& route, int hop_count)
{
...
#line 842 "../../net/aodvii.h"

#line 842 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::RepairTimer(ether_addr_t& dst_addr, unsigned int)
{
...
#line 864 "../../net/aodvii.h"

#line 864 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::from_mac_ack (bool success)
{
    if(!success)
    {
...
#line 901 "../../net/aodvii.h"

#line 901 "../../net/aodvii.h"
/*template <class PLD>
*/void compcxx_AODVII_20/*<app_packet_t >*/::from_pm_node_up()
{
  return;
}
  ...
  trigger_t	&)
{
  ...
  else		
  {
    ...
    m_switch_on = true;
    (p_compcxx_AODVII_20->from_pm_node_up());		
...
*/void compcxx_FIFOACK3_26 /*<net_packet_t* ,ether_addr_t ,unsigned int >*/::in (net_packet_t* const& t1, ether_addr_t const& t2, unsigned int const& t3)
{
	...
	(p_compcxx_AODVII_20->from_mac_ack(true));
    }
    else
    {
	(p_compcxx_MAC80211_21->from_network(t1,t2,t3));
...
*/void compcxx_FIFOACK3_26 /*<net_packet_t* ,ether_addr_t ,unsigned int > */:: next (const bool& flag)
{
    ...
    {
	(p_compcxx_AODVII_20->from_mac_ack(flag));
    }
    return;
}
...
void compcxx_SensorNode_27::Setup()
{
    ...
    app.p_compcxx_AODVII_20=&net /*connect app.to_transport, net.from_transport*/;
    ...
    queue.p_compcxx_AODVII_20=&net /*connect queue.ack, net.from_mac_ack*/;
    mac.p_compcxx_AODVII_20=&net /*connect mac.to_network_data, net.from_mac_data */;
    ...
    pm.p_compcxx_AODVII_20=&net /*connect pm.from_pm_node_up, net.from_pm_node_up*/;
